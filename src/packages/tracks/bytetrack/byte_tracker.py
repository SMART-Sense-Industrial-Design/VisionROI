import numpy as np
from tracks.bytetrack import matching
from tracks.bytetrack.basetrack import BaseTrack, TrackState
from tracks.bytetrack.kalman_filter import KalmanFilter
...
class BYTETracker(object):
    ...
    def update(self, xyxys, confs, classes):
        self.frame_id += 1
        activated_starcks = []
        refind_stracks = []
        lost_stracks = []
