...
from models.yolov8.yolov8onnx.yolov8seg.utils import xywh2xyxy, nms, draw_detections, sigmoid
...
class YOLOSeg:
    ...
    def draw_detections(self, image, class_names, draw_scores=True, mask_alpha=0.4):
        return draw_detections(image, self.boxes, self.scores, class_names,
                               self.class_ids, mask_alpha)

    def draw_masks(self, image, class_names, draw_scores=True, mask_alpha=0.5):
        return draw_detections(image, self.boxes, self.scores, class_names,
