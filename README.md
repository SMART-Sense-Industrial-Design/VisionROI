...
- รองรับการเชื่อมต่อฐานข้อมูล PostgreSQL ผ่าน connection pool
...
- `psycopg2-binary` – สำหรับเชื่อมต่อ PostgreSQL
...
- `DB_HOST` (ดีฟอลต์: `localhost`)
- `DB_PORT` (ดีฟอลต์: `5432`)
- `DB_NAME` (ดีฟอลต์: `nisitsirimarnkit`)
- `DB_USER` (ดีฟอลต์: `postgres`)
- `DB_PASSWORD` (ดีฟอลต์: ค่าว่าง)
