...
## การมีส่วนร่วม
หากต้องการมีส่วนร่วมในการพัฒนา โปรดทำดังนี้:

1. Fork โปรเจ็กต์นี้แล้วสร้าง branch ของคุณเอง
2. ติดตั้ง dependencies และรันเทสต์เพื่อให้แน่ใจว่าทุกอย่างทำงานถูกต้อง
3. ส่ง Pull Request พร้อมคำอธิบายการเปลี่ยนแปลง
