...
- ตรวจจับหน้ากระดาษและ ROI แบบเพจผ่านหน้า `/inference_page`
...
4. หากต้องการตรวจจับหน้ากระดาษ ให้เข้า `/inference_page` เพื่อดูผลลัพธ์การตรวจจับเพจ
...
ใช้สำหรับตรวจจับหน้ากระดาษหรือเพจ และแสดงผลลัพธ์ของแต่ละเพจเพื่อใช้งานต่อ
